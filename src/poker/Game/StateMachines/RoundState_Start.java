 ...
 * @author MDA 174321 :)
 */
public class RoundState_Start implements State {

    public RoundState_Start(StateMachine aStateMachine) {
        if (aStateMachine instanceof Round){
            Round round = (Round)aStateMachine;
            Utils.logState("Game id: "+ round.getGameId() +" Round id: "+ round.getId() + " transitions to RoundState_Start.");
        }        
    }
